...
export function HeaderAvaliador() {
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="text-right hidden sm:block">
                    ...
                    <p className="text-xs text-cor-texto opacity-60">Avaliador Externo</p>
                  </div>
                  <div
              ...
              {showUserMenu && (
                <div ref={userMenuRef} className="absolute right-0 mt-2 w-56 bg-cor-superficie rounded-lg shadow-lg border border-cor-borda py-2">
                  <div className="px-4 py-2 border-b border-cor-borda">
                    <p className="text-sm font-medium text-cor-texto">{usuario?.nome_completo ?? 'Usuário'}</p>
