      ...
      <header className="bg-cor-superficie border-b border-cor-borda">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div>
              <h1 className="text-xl font-bold text-cor-texto">Dashboard do Coordenador</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-cor-superficie rounded-lg p-6 shadow">
          ...
          <p className="text-cor-texto opacity-75">
            Esta página está em construção. Em breve você terá acesso às funcionalidades do coordenador.
          </p>
        </div>
      </main>
    </div>
