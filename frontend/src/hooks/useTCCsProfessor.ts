/**
 * Hook para buscar TCCs do professor (orientandos)
 */
...
interface UseTCCsProfessorResult {
  tccs: TCC[];
  carregando: boolean;
  erro: string | null;
...
export function useTCCsProfessor(): UseTCCsProfessorResult {
  ...
  const buscarTCCs = useCallback(async () => {
    ...
    try {
      ...
      // Para professor, o endpoint retorna array de TCCs
